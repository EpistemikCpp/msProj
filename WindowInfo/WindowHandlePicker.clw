...
Resource3=IDM_TASKBARICON (Neutral (Default))
...
Class6=COptionsDlg
Resource7=IDD_WINDOWHANDLEPICKER_DIALOG
Resource8=IDD_OPTIONSDLG (French (Belgium))
...
[DLG:IDD_OPTIONSDLG (French (Belgium))]
Type=1
Class=?
ControlCount=2
Control1=IDOK,button,1342242817
