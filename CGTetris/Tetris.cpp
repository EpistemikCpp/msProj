...
//            : CTetrisApp constructor, instantiation, & initialization
...
CTetrisApp::CTetrisApp()
  {
   // Place construction code here
   // Do all initialization in InitInstance()
  }
...
BOOL CTetrisApp :: GetHiScore(int index, CString & strName,
															UINT & uScore, UINT & uLevel)
	{
	CString strSection;
...
void CTetrisApp :: WriteHiScore(int index, const CString & strName,
																UINT uScore, UINT uLevel)
	{
	CString strSection;
	strSection.Format(TEXT("Score%d"), index);
...
BOOL CTetrisApp :: GetWantSequence()
	{	return GetProfileInt(TEXT("Options"), TEXT("Sequence"), 0); }

void CTetrisApp :: WriteWantSequence(BOOL bWant)
	{ WriteProfileInt(TEXT("Options"), TEXT("Sequence"), int(bWant)); }

DWORD CTetrisApp :: GetVolume()
	{	return DWORD(GetProfileInt(TEXT("Options"), TEXT("MusicVolume"), 50)); }

void CTetrisApp :: WriteVolume(DWORD dwPercent)
	{ WriteProfileInt(TEXT("Options"), TEXT("MusicVolume"), int(dwPercent)); }

CString CTetrisApp :: GetMusicFileName()
	{ return GetProfileString(TEXT("Options"), TEXT("MusicFile")); }

void CTetrisApp :: WriteMusicFileName(const CString & strFile)
	{	WriteProfileString(TEXT("Options"), TEXT("MusicFile"), strFile); }

void CTetrisApp::WinHelp(DWORD dwData, UINT nCmd) 
  {	}// we don't like to call WinHelp...
