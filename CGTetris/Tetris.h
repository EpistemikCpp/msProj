...
/////////////////////////////////////////////////////////////////////////////
// CTetrisApp: See Tetris.cpp for the implementation of this class
//
...
public:
	...
	BOOL	GetWantSequence();
	void	WriteWantSequence(BOOL bWant);
	DWORD	GetVolume();
	void	WriteVolume(DWORD dwPercent);
	CString	GetMusicFileName();
	void	WriteMusicFileName(const CString &);
