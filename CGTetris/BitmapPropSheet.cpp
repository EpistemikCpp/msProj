...
CBitmapPropSheet::CBitmapPropSheet( UINT nIDCaption, CWnd* pParentWnd,
                                    UINT iSelectPage )
...
CBitmapPropSheet::CBitmapPropSheet( LPCTSTR pszCaption, CWnd* pParentWnd,
                                    UINT iSelectPage )
...
BOOL CBitmapPropSheet::OnInitDialog() 
{
